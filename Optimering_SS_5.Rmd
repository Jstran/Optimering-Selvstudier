...
I det lineære tilfælde er $\alpha_k$ valgt som den værdi der minimerer den streng konveks kvadratiske objektfunktion 
For ikke-lineære funktioner skal $\alpha_k$ vælges som den værdi der approksimativt minimerer obejktfunktionen langs retningen $p_k$.  
