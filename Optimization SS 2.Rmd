...
\begin{align*}
    O(h)
\end{align*}
Trunkeringsfejlen angives som store-$O$ af $h$ i den laveste potens, idet vi kun er interesseret i $h < 1$.
At trunkeringsfejlen er store-$O$ af $h$, betyder, at der eksisterer en konstant $M$, sådan at
\begin{align*}
    | c_1 h + c_2 h^2 + \cdots | \leq M \cdot h.
\end{align*}
...
\textbf{Praktisk eksempel for sammenligning af metoderne}
```{r}
